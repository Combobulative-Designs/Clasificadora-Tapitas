...
const RGBColor samples1[12] PROGMEM = {
        {114, 95, 75}, {112, 95, 72}, {160, 70, 62}, {136, 94, 61}, {157, 76, 49}, {129, 81, 76},
        {152, 70, 69}, {81, 103, 96}, {100, 110, 71}, {95, 110, 78}, {126, 89, 70}, {0, 0, 0}
};

const RGBColor samples2[12] PROGMEM = {
        {114, 95, 75}, {112, 95, 72}, {160, 70, 62}, {136, 94, 61}, {157, 76, 49}, {129, 81, 76},
        {152, 70, 69}, {81, 103, 96}, {100, 110, 71}, {95, 110, 78}, {126, 89, 70}, {0, 0, 0}
};

const RGBColor samples3[12] PROGMEM = {
        {114, 95, 75}, {112, 95, 72}, {160, 70, 62}, {136, 94, 61}, {157, 76, 49}, {129, 81, 76},
        {152, 70, 69}, {81, 103, 96}, {100, 110, 71}, {95, 110, 78}, {126, 89, 70}, {0, 0, 0}
};

const RGBColor samples4[12] PROGMEM = {
        {114, 95, 75}, {112, 95, 72}, {160, 70, 62}, {136, 94, 61}, {157, 76, 49}, {129, 81, 76},
        {152, 70, 69}, {81, 103, 96}, {100, 110, 71}, {95, 110, 78}, {126, 89, 70}, {0, 0, 0}
};

const RGBColor samplesArchive[4][12] PROGMEM = { {samples1}, {samples2}, {samples3}, {samples4} };
