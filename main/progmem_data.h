...
const RGBSampleSet samples1 PROGMEM = {
        {{90,103,71}, {107, 98, 67}, {150,71,56}, {115,97,49}, {143,81,48}, {119,86,70},
                {138,76,65}, {78,106,88}, {90,113,67}, {84,112,73}, {111,95,66}, {90,94,99}}, {0, 0, 0}
};
const RGBSampleSet samples2 PROGMEM = {
        {{90,103,71}, {107, 98, 67}, {150,71,56}, {115,97,49}, {143,81,48}, {119,86,70},
                {138,76,65}, {78,106,88}, {90,113,67}, {84,112,73}, {111,95,66}, {90,94,99}}, {0, 0, 0}
};
const RGBSampleSet samples3 PROGMEM = {
        {{90,103,71}, {107, 98, 67}, {150,71,56}, {115,97,49}, {143,81,48}, {119,86,70},
                {138,76,65}, {78,106,88}, {90,113,67}, {84,112,73}, {111,95,66}, {90,94,99}}, {0, 0, 0}
};
const RGBSampleSet samples4 PROGMEM = {
        {{90,103,71}, {107, 98, 67}, {150,71,56}, {115,97,49}, {143,81,48}, {119,86,70},
                {138,76,65}, {78,106,88}, {90,113,67}, {84,112,73}, {111,95,66}, {90,94,99}}, {0, 0, 0}
};

const RGBSampleSet samplesArchive[4] PROGMEM = { samples1, samples2, samples3, samples4 };  // 90,94,99 86,98,90

const char sampleNames[12][11] PROGMEM = {
        "Black\0\0\0\0\0",
        "White\0\0\0\0\0",
        "Red\0\0\0\0\0\0\0",
        "Yellow\0\0\0\0",
